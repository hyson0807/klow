...
> **📦 보관 문서 (실행 완료 · 2026-07-18):** 이 릴리스는 프로덕션에 나갔고 그 뒤 가격 모델이 두 번
> 더 바뀌었다(2026-07-28 물류비 분리 · 2026-07-29 무료배송 국가별 전환). 현행 가격 모델은
> [`../reference/pricing-model.md`](../reference/pricing-model.md) 참고. **여기 적힌 게이트·순서를
> 현재 기준으로 인용하지 말 것** — 배포 순서 판단의 선례로만 남긴다.
