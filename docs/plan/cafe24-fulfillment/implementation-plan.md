...
### 0. 카페24 개발자센터 앱 생성 (사용자 작업 — 코드 없음 · **1~2-1 과 병행**)

⚠️ **이 단계를 기다리지 않는다** (2026-09-23 사용자 결정 — 개발자센터 가입에 하루쯤 걸린다).
1단계와 2-1 은 자격증명 없이 쓸 수 있으므로 **코드를 먼저 쓰고**, 이 단계는 그 사이에 병행한다.
...
### 3~5 · 7~8 (제목과 범위만 — 6단계는 아래에 따로 명세한다)
...
| 8 | 퍼블릭앱 심사 제출 | **외부 대기.** 심사자는 동작하는 앱을 본다 — 6·7 이 먼저다 |
